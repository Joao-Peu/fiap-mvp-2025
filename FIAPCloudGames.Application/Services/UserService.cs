...
namespace FIAPCloudGames.Application.Services
{
    public class UserService
    {
        ...
        public IEnumerable<Game> GetLibrary(Guid userId)
        {
            var user = _userRepository.GetById(userId);
            return user?.Library ?? Enumerable.Empty<Game>();
        }
